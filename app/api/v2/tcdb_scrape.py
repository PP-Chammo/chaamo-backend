...
@router.get("/sets", response_model=SetsResponse, summary="Discover card sets by category/brand")
async def discover_sets_endpoint(
    category: ScrapeTarget = Query(..., description="Select a category/brand to discover sets for")
):
    try:
